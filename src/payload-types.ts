...
export interface Config {
  ...
  collectionsSelect: {
    ...
    costtable: CosttableSelect<false> | CosttableSelect<true>;
...
export interface Service {
  id: number;
  title: string;
  icon: 'TeaPot' | 'Scroll' | 'Gates' | 'Gong' | 'Noodles' | 'BaGua' | 'Drum' | 'Sage';
  duration: string;
  price: string;
  short: string;
  full: string;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'costtable';
        value: number | Costtable;
      } | null)
    | ({
        relationTo: 'reviews';
        value: number | Review;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "costtable_select".
 */
export interface CosttableSelect<T extends boolean = true> {
  program?: T;
  price?: T;
  note?: T;
  updatedAt?: T;
