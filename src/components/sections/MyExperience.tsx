...
const ExperienceSection: React.FC = () => {
  ...
  const fadeInSide = (direction: number): Variants => ({
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="min-[899px]:hidden block relative z-10 max-w-5xl mx-auto py-10 px-4">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInDown} className="mb-8 flex items-center gap-5">
      ...
      <div className="min-[900px]:block hidden relative w-full">
        <div className="max-w-7xl mx-auto py-16 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInDown} className="relative z-10 mb-8 flex items-center gap-5">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInDown} className="relative z-10 mb-12 p-8 text-center text-lg leading-relaxed text-[#4a4a2a] border-2 border-[#636024] rounded-2xl bg-[#FCFDED]">
            В Китай я поступала почти самостоятельно. Почему почти? Потому что изначально мне помогала одна достаточно известная языковая школа. Но по факту она не дала того качества услуг, за которое были заплачены деньги. В итоге большую часть процесса я разбирала сама — от выбора университетов до требований к документам.
          </motion.div>
          ...
          <div className="relative z-10 grid grid-cols-12 gap-8 items-stretch">
            ...
            <div className="col-span-6 border-2 border-[#636024] rounded-[32px] p-2 bg-[#FCFDED]">
              <div className="border-2 border-[#636024] rounded-[24px] p-6 h-full flex flex-col gap-6 justify-between">
                ...
                <motion.div custom={0.4} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInSide(-30)} className="p-6 border-2 border-[#636024] rounded-2xl bg-[#FCFDED]">
                ...
                <motion.div custom={0.6} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInSide(-30)} className="p-6 border-2 border-[#636024] rounded-2xl bg-[#FCFDED]">
                ...
                <motion.div custom={0.8} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInSide(-30)} className="p-6 border-2 border-[#636024] rounded-2xl bg-[#FCFDED]">
            ...
            <div className="col-span-6 border-2 border-[#636024] rounded-[32px] p-2 bg-[#FCFDED] relative flex flex-col min-h-[600px]">
              <div className="relative w-full h-full rounded-[24px] overflow-hidden flex-1 p-8 flex flex-col gap-5 justify-start">
                ...
                <motion.div custom={1.0} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInSide(30)} className="relative z-10 p-5 bg-[#FCFDED] border-2 border-[#636024] rounded-xl max-w-[85%] mx-auto text-center shadow-md mt-4">
                ...
                <motion.div custom={1.2} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInSide(30)} className="relative z-10 p-5 bg-[#FCFDED] border-2 border-[#636024] rounded-xl max-w-[85%] mx-auto text-center shadow-md">
