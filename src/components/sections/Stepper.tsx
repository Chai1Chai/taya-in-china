...
import StepperImage from "@/assets/Stepper_background.webp";
...
const Stepper: React.FC = () => {
  return (
    ...
    >
      <h2 className="font-[family-name:var(--font-mm9)] uppercase text-3xl md:text-6xl leading-[60px] md:leading-[84px] font-normal mb-24 text-[#5E0F08] text-center">
        Этапы сопровождения
      </h2>
